...
public class MainActivity extends SlidingFragmentActivity {
	...
	private void setUpListSlidingMenu(){
		...
		smItem.add(new SlidingMenuEntryItem(R.drawable.gift48, R.string.shopping));
		smItem.add(new SlidingMenuEntryItem(R.drawable.gift48, R.string.food));
		smItem.add(new SlidingMenuEntryItem(R.drawable.gift48, R.string.entertainment));
		smItem.add(new SlidingMenuEntryItem(R.drawable.gift48, R.string.travel));
		smItem.add(new SlidingMenuEntryItem(R.drawable.gift48, R.string.coffee_scream));
		smItem.add(new SlidingMenuEntryItem(R.drawable.gift48, R.string.health));
