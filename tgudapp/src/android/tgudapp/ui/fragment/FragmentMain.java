		...
		jsonBannerRequest = new JsonArrayRequest(
				...
				new Listener<JSONArray>() {
					...
					public void onResponse(JSONArray response) {
						...
						mPagerBannerAdapter = new PagerBannerAdapter(getFragmentManager(), listBanner);
						...
						try {
							...
							for(int i = 0; i< listPlace.size(); i++){
								...
								if(listFood.size() != 0){
									...
									hlvFood.setAdapter(new HorizontalListPlaceAdapter(getActivity(), listFood,mImageLoader));
								...
								if(listTravel.size() != 0){
									...
									hlvTravel.setAdapter(new HorizontalListPlaceAdapter(getActivity(), listTravel,mImageLoader));
								...
								if(listShopping.size() != 0){
									...
									hlvShopping.setAdapter(new HorizontalListPlaceAdapter(getActivity(), listShopping,mImageLoader));
								...
								if(listHealth.size() != 0){
									...
									hlvHealth.setAdapter(new HorizontalListPlaceAdapter(getActivity(), listHealth,mImageLoader));
								...
								if(listEntertainment.size() != 0){
									...
									hlvEntertainment.setAdapter(new HorizontalListPlaceAdapter(getActivity(), listEntertainment,mImageLoader));
								...
								if(listCoffeeScream.size() != 0){
									...
									hlvCoffeeScream.setAdapter(new HorizontalListPlaceAdapter(getActivity(), listCoffeeScream,mImageLoader));
